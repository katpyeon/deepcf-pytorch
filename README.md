...
│   ├── ml-1m-sample20.*                # 샘플: 20명 유저
│   ├── ml-1m-sample100.*               # 샘플: 100명 유저
...
**샘플 데이터셋:**
- `ml-1m-sample20`: 20명 유저 (빠른 테스트용)
- `ml-1m-sample100`: 100명 유저 (빠른 실험용)
- `ml-1m-sample500`: 500명 유저 (중간 규모)
- `ml-1m-sample1000`: 1000명 유저 (대규모 실험)
